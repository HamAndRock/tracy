...
<div class="tracy-collapsed"><span class="tracy-dump-indent">   </span><span class="tracy-dump-virtual">%a%</span> => <span class="tracy-dump-bool">%a%</span>%A%', Dumper::toHtml(fopen(__FILE__, 'r')));
