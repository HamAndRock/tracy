...
$arr[] = &$arr;
Assert::match(
	'<pre class="tracy-dump" data-tracy-dump=\'[[0,1],[1,2],[2,3],[3,[[0,1],[1,2],[2,3],[3,{"array":[],"cut":"r","length":4},1]],1]]\'></pre>',
...
$arr = [1, [2, [3, [4, [5, [6]]]]], 3];
Assert::match(
	'<pre class="tracy-dump" data-tracy-dump=\'[[0,1],[1,[[0,2],[1,[[0,3],[1,[[0,4],[1,{"array":[],"cut":"d","length":2}]]]]]]],[2,3]]\'></pre>',
	Dumper::toHtml($arr, $options)
);
Assert::same([], Dumper::$liveSnapshot);
